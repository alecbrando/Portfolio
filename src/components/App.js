    ...
    <div>
      ...
      <div ref={(el) => (hero = el)} className={landingStyles.hero}>
        <div className={landingStyles.inner_hero}>
          <div
            ref={(el) => (mainLogo = el)}
            className={landingStyles.inner_hero_container}
          >
          ...
          <section ref={(el) => (section = el)}>
            ...
            <span className={landingStyles.line}>|</span>
            <a href="#about">About</a>
            <span className={landingStyles.line}>|</span>
            <a
              href="https://github.com/alecbrando"
              target="_blank"
      ...
      <div id="projects" className={landingStyles.workList_container}>
        <div
          ref={(el) => (projects = el)}
          className={landingStyles.workList_container_inner}
        >
          ...
          <div
            ...
            className={landingStyles.workList_container_projects}
          >
            <Project
              img={img6}
              title="Red Flag App"
              ...
              skill7="AWS DynamoDB"
              skill8="AWS AppSync"
              url1="https://github.com/alecbrando/RedFlagDocumentation"
              url2="https://github.com/alecbrando/RedFlagDocumentation"
              url3=""
              dribble="false"
            ...
            <Project
              ...
              skill7="Git"
              skill8="CSS/SCSS"
              url1="https://github.com/alecbrando/Digitize"
            ...
            <Project
              ...
              skill7="NodeJS"
              skill8="AWS"
              url1="https://github.com/alecbrando/Twitchr"
            ...
            <Project
              ...
              skill7="Javascript"
              skill8="Python"
              url1="https://github.com/jlgranof/Galactic-Brite"
            ...
            <Project
              ...
              skill7="Sequelize"
              skill8=""
              url1="https://github.com/ivanhroth/question-forum"
      ...
      <div className={landingStyles.content_container}>
        ...
        <div id="about" className={landingStyles.content_box}>
          <div
            ref={(el) => (about = el)}
            className={landingStyles.content_about}
          >
            <h4>
              Software Engineer<strong> |</strong>
              <span> Alec Garcia</span>
            </h4>
            <p>
              With a passion for software engineering, I have the expertise in
              languages and frameworks such as React, React Native, Redux,
              Javascript, TypeScript, SQLAlchemy, Flask, Apollo GraphQL,
              MongoDB, HTML and CSS. As a confident individual with the skills
              to succeed I envision an exciting future in the industry.{" "}
              <strong>
                <a href="https://docs.google.com/document/d/1mSbuQOgh74WXe9g8VWeskz3kbu3dcmzVVvy1EIblU2E/edit?usp=sharing">
                  Resume
                </a>
              </strong>
            </p>
            <p>
              Delivering a fast and elegant user experience is at the heart of
              my programming philosphy.
            </p>
            <p>
              <a href="mailto:alecbrandongarcia@gmail.com">Send email</a>
            </p>
          </div>
          <hr />
          <div
            ref={(el) => (skills = el)}
            className={landingStyles.content_skills}
          >
            <h4>
              Skills<span>.</span>
            </h4>
            <ul>
              <li>
                ...
                <section>
                  React, React Native, Redux, JavaScript, TypeScript, HTML,
                  CSS/SCSS, Front-end Frameworks{" "}
                  <p> - (Bootstrap / Material-UI / Semantic ui)</p>{" "}
                </section>
              </li>
              <li>
                <h5>
                ...
                <p>
                  NodeJS, Express, Flask, SQLAlchemy, Python, GraphQL,
                  DynamboDB, MongoDB, ApolloGraphQL
                </p>
              </li>
              <li id="contact">
                <h5>
